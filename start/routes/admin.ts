...
const SlideController = () => import('#controllers/slide_controller')
...
export default function adminRoutes() {
  ...
  router.get('/slides/create', [SlideController, 'create']).as('slides.create')
  router.post('/slides-order', [SlideController, 'order']).as('slides.order')
  router
    .resource('/slides', SlideController)
    .only(['index', 'store', 'destroy', 'edit', 'update'])
    .as('slides')
  router.get('/slides/list', [SlideController, 'list']).as('slides.list')
